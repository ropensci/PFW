...
If you chose a different file path for `pfw_download`, you'll want to enter it where "data_raw" is in that example. Alternatively, an example dataset is provided, pre-filtered to data from Washington and Oregon from 2021 - May 2024. You can call this dataset easily with
