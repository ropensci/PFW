...
Doing so will download the data from the [GitHub repository](https://github.com/ropensci/PFW/blob/main/inst/extdata/pfw_example.csv) the first time you use it and call upon the existing file in following uses.
